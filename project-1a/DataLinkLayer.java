 ...
 *
 *       A data link layer accepts a string of bytes, divides it into frames,
 *       adds
 *       some metadata, and sends the frame via its physical layer. Upon
 *       receiving a
 *       frame, the data link layer removes the metadata, potentially performs
 *       some
